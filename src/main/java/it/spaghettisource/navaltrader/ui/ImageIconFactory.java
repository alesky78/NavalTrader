...
public class ImageIconFactory {
	...
	private static Image getImageByName(String name) {
	...
	public static BufferedImage getBufferImageByName(String name) {
	...
	public static ImageIcon getImageIconByName(String name) {
		return new ImageIcon(getImageByName(name) );
	}


	public static ImageIcon getImageIconByNameAndSize(String name,int size) {
